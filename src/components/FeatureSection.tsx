    ...
    <div className="container-fluid bg-primary overflow-hidden my-5 px-lg-0">
      <div className="container feature px-lg-0">
        <div className="row g-0 mx-lg-0">
          <ScrollReveal animation="fadeIn" delay="0.1s" className="col-lg-6 feature-text py-5">
          ...
          <ScrollReveal animation="fadeIn" delay="0.5s" className="col-lg-6 pe-lg-0" style={{ minHeight: '400px' }}>
            <div className="position-relative h-100">
              <img className="position-absolute img-fluid w-100 h-100" src={featureImg} style={{ objectFit: 'cover' }} alt="Feature" />
            </div>
          </ScrollReveal>
        </div>
      </div>
